...
function App(props) {
  ...
  const networkOptions = [initialNetwork.name, "polygon", "mumbai", "goerli"];
  ...
  const purpose = useContractReader(readContracts, "SlotMachine", "users", [], localProviderPollingTime);
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Header title="🎰 Lotero" subTitle="A decentralized casino with juicy rewards! 🚀">
      ...
      <div style={{ position: "fixed", textAlign: "left", left: 0, bottom: 20, padding: 10 }}>
        <Row align="middle" gutter={[4, 4]}>
          ...
          <Col span={8} style={{ textAlign: "center", opacity: 1 }}>
            <Button
              onClick={() => {
                window.open("https://t.me/+QeBCUuk5NKAxZDkx");
              }}
              size="large"
              shape="round"
            >
