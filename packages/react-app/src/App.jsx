...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "SlotMachine", "purpose", [], localProviderPollingTime);
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Header title="🎰 Decentralized Slot Machine" subTitle="A decentralized slot machine with juicy rewards! 🚀">
